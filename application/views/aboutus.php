						...
						<div class="aside">
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h3 class="product-name"><a href="<?php echo base_url('details/'); ?>"><?php echo $product->nama_product; ?></a></h3>
...
<!-- 								<li><a href="#"><i class="fa fa-th-list"></i></a></li> -->
						...
						<div class="row">
							...
							<!-- product -->
							<?php $break=0; $i=0; foreach (array_reverse($dataproduct) as $product) { $break++; if($product->kategori == 'Sound System'){ $i++; ?>
